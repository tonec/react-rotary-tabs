...
describe('withRotary HoC', () => {
  ...
  const HoCTestComponent = withRotary(TestComponent)
  ...
  // it('should initiate with 0 if no initialActiveTab has been passed in', () => {
  //
  // })

    // should initiate with the correct tab if an initialActiveTab is passed in

    // should cycle through each tab
